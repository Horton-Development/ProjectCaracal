...
public class Game extends JFrame{
	...
	public Game(){
		...
		getContentPane().setName("Content pane");
		...
		panel.add(button, "30, 10, 1, 4");
		
		Button button_1 = new Button("Load Game");
		button_1.setFont(new Font("Trebuchet MS", Font.BOLD, 26));
		panel.add(button_1, "30, 18, 1, 4");
		
		Button button_2 = new Button("Exit");
		button_2.setFont(new Font("Trebuchet MS", Font.BOLD, 26));
		panel.add(button_2, "30, 26, 1, 4");
